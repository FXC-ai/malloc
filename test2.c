...
void test17()
{
    void *ptr1 = malloc(4095);
    t_heap *heap1 = (t_heap *) HEAP_UNSHIFT(BLOCK_UNSHIFT(ptr1));

    void *ptr2 = malloc(8191);
    t_heap *heap2 = (t_heap *) HEAP_UNSHIFT(BLOCK_UNSHIFT(ptr2));

    void *ptr3 = malloc(12287);
    t_heap *heap3 = (t_heap *) HEAP_UNSHIFT(BLOCK_UNSHIFT(ptr3));
    
    void *ptr4 = malloc(16383);
    t_heap *heap4 = (t_heap *) HEAP_UNSHIFT(BLOCK_UNSHIFT(ptr4));
    ...
    delete_heap(heap2, &heap_anchor);
    show_alloc_mem();
    write(1, "\n" ,1);

    delete_heap(heap4, &heap_anchor);
    show_alloc_mem();
    write(1, "\n" ,1);

    delete_heap(heap3, &heap_anchor);
    show_alloc_mem();
    write(1, "\n" ,1);
    
    delete_heap(heap1, &heap_anchor);
    show_alloc_mem();
    write(1, "\n" ,1);
}
